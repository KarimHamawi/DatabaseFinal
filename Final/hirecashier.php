...
{		
    ...
    $salary=$_POST['doctorcharge'];
    $sex=$_POST['gender'];
    $insert = mysqli_query($con,"INSERT INTO CASHIER VALUES ('$id','$firstname','$lastname','$password','$yearofbirth','$sex','$email','$salary','$address')");
...
<body style="background-color:#333;">
            ...
            <form class="signup-form"  action="hirecashier.php"  method="post" style="margin:1vh;">
<!-- form header -->
<div class="form-header wow slideInDown" data-wow-duration="1s">
  <h1>Hire a Cashier</h1>
</div>
...
<div class="form-body wow slideInUp" data-wow-duration="1s">
  ...
  <div class="horizontal-group">
    <div class="form-group left">
      ...
      <input type="text" name="ID" class="form-input" placeholder="example CA01" required="required" />
    </div>
    <div class="form-group right">
