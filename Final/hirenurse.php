...
{		
    ...
    $sex=$_POST['gender'];
    $insert = mysqli_query($con,"INSERT INTO NURSE VALUES ('$id','$firstname','$lastname','$password','$yearofbirth','$sex','$email','$doccharge','$shift','$address')");
...
<body style="background-color:#333;">
            ...
            <form class="signup-form"  action="hirenurse.php"  method="post" style="margin:1vh;">
<!-- form header -->
...
<div class="form-body wow slideInUp" data-wow-duration="1s">
  ...
  <div class="horizontal-group">
    ...
    <div class="form-group right">
    <label class="label-title">Shift</label>
  ...
  <div class="horizontal-group">
    <div class="form-group left">
      ...
      <input type="text" name="ID" class="form-input" placeholder="example N01" required="required" />
    </div>
    <div class="form-group right">
  ...
  <div class="horizontal-group">
    ...
    <div class="form-group right">
      <label for="experience" class="label-title">Salary</label>
      <input type="range" min="0" max="10000" step="1"  value="0" id="experience" name="doctorcharge" class="form-input" onChange="change();" style="height:28px;width:78%;padding:0;">
